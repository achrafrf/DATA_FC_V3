            ...
            <div className="bg-indigo-50">
                <div className="xl:px-20 md:px-10 sm:px-6 px-4 md:py-12 py-9 2xl:mx-auto 2xl:container md:flex items-center justify-center">
                    <div className="bg-white shadow-lg rounded xl:w-1/3 lg:w-5/12 md:w-1/2 w-full lg:px-10 sm:px-6 sm:py-10 px-2 py-6">
                        ...
                        <div className="mt-8">
                            <button role="button" className="focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 text-sm font-semibold leading-none text-white focus:outline-none bg-teal-600 border rounded hover:bg-teal-500 py-4 w-full">
                                Login
                            </button>
                        </div>
                    </div>
                    <div className="xl:w-1/3 md:w-1/2 lg:ml-16 ml-8 md:mt-0 mt-6">
                        ...
                        <Image src="/logo.png" alt="logo" height={3000} width={2000} />
                        </div>
                        <div className="flex items-start mt-8">
                        <p className="sm:text-2xl text-xl leading-7 text-gray-600 pl-2.5">Ce lieu est réservé uniquement à l administrateur. </p>
                        </div>
                        <div className="flex items-center pl-8 mt-10">
                            <div className="w-8 h-8">
                                <Image src="https://i.ibb.co/xLtZCRT/Mask-Group.png" alt="profile picture" className="w-full h-full" height={3000} width={2000}/>
                            </div>
                            <div className="ml-2">
                                <p className="text-sm font-bold leading-none text-gray-800">Le Directeur Aziz CHAKIK</p>
