...
const NosValeurs = () => {
  return (
    <div className='mt-8 mb-9 px-4 sm:px-6 lg:px-8'>
       {/* العنوان الرئيسي */}
       <h1 className="mb-8 mt-12 text-center font-extrabold leading-none tracking-tight text-gray-900 text-3xl sm:text-4xl md:text-5xl lg:text-4xl dark:text-white">
         Nos<mark className="px-2 ml-1 text-white bg-teal-600 rounded-sm dark:bg-teal-500">Valeurs</mark>
       </h1>
       
       {/* النص التوضيحي */}
       <p className="font-normal text-lg sm:text-xl lg:text-2xl leading-6 text-gray-500 mt-6 lg:mt-10 dark:text-white">
         Nos activités professionnelles reposent sur un équilibre de cinq piliers :
       </p>

       {/* الصف الأول من القيم */}
       <div className="relative mt-8 lg:mt-14 z-10">
       ...
       {/* نصوص الصف الأول */}
       <div className="grid grid-cols-3 sm:grid-cols-3 gap-2 sm:gap-4 lg:gap-8 mt-4 lg:mt-6">
           <div>
               <p className="font-semibold text-sm sm:text-base lg:text-xl xl:text-2xl leading-5 lg:leading-6 text-gray-800 dark:text-white">
                 L’innovation
               </p>
           </div>
           <div>
       ...
       {/* نصوص الصف الثاني */}
       <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 sm:gap-4 lg:gap-8 mt-4 lg:mt-6">
           <div>
               <p className="font-semibold text-sm sm:text-base lg:text-xl xl:text-2xl leading-5 lg:leading-6 text-gray-800 dark:text-white">
                 Le respect
               </p>
