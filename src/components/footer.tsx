...
export const Footer = () => {
  return (
<footer  
  className="bg-gradient-to-r from-amber-300 to-amber-400 text-center text-surface/75 dark:bg-gray-800  dark:text-white/75 lg:text-left">
  <div
  ...
  <ul className="flex flex-col gap-3 md:gap-2">
      ...
      <li className="flex items-start gap-2">
        <FaEnvelope className="text-emerald-700 mt-1" />
        <span>datafc2019@gmail.com</span>
      </li>
      <li className="flex items-start gap-2">
  ...
  <div className=" bg-teal-600 p-3 text-center">
    ...
    <a className="font-bold">DATA FC</a
    >
  </div>
</footer>
  );
